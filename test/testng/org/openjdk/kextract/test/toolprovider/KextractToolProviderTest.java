 ...
 * questions.
 */
package org.openjdk.kextract.test.toolprovider;
...
public class KextractToolProviderTest extends KextractToolRunner {
    ...
    public void testEmptyOptionValue() {
        runNoOuput("-D", "", getInputFilePath("hello.h").toString())
            ...
            .checkContainsOutput("Usage: kextract <options> <header file>");
    }
    ...
    // @bug 8267504: kextract should report unsupported language and exit rather
