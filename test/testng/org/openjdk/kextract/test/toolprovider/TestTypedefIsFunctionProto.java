...
public class TestTypedefIsFunctionProto extends KextractToolRunner {
    @Test
    public void testVoidTypedef() {
        ...
        // nothing is generated that we can check, so we just check that kextract ran successfully
