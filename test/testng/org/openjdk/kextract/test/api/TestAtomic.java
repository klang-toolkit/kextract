 ...
 * questions.
 */
package org.openjdk.kextract.test.api;
...
import testlib.KextractApiTestBase;

import static org.testng.Assert.*;
import static org.openjdk.kextract.Type.Primitive.Kind.*;
import static org.openjdk.kextract.Type.Delegated.Kind.*;

import java.nio.file.Path;
import java.nio.file.Paths;
import java.util.EnumSet;

public class TestAtomic extends KextractApiTestBase {
    Declaration.Scoped atomic;

    @BeforeClass
    public void parse() {
        // We need stdatomic.h
        Path builtinInc = Paths.get(System.getProperty("java.home"), "conf", "kextract");
