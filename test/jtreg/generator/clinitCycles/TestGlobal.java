 ...
 * @run main/othervm JtregKextract -t test.kextract.clinit --library ClinitGlobal --use-system-load-library -Dkextract.decls.per.header=1 clinit_global.h
 * @build TestGlobal
