...
import test.kextract.testLinkageErrors.*;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertTrue;
import static test.kextract.testLinkageErrors.testLinkageErrors_h.*;

/*
 * @test
 * @bug 8259473
 * @summary kextract generated code should throw exception for unfound native symbols from calls, variable access, set immediately
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -t test.kextract.testLinkageErrors testLinkageErrors.h
