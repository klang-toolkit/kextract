...
import test.kextract.test8258605.*;
import static java.lang.foreign.MemorySegment.NULL;
import static org.testng.Assert.assertFalse;
import static org.testng.Assert.assertTrue;
import static test.kextract.test8258605.funcParam_h.*;

/*
 * @test
 * @bug 8258605
 * @summary regression: kextract can not handle function prototypes as function arguments
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l FuncParam --use-system-load-library -t test.kextract.test8258605 funcParam.h
