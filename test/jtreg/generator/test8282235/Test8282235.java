...
import test.kextract.test8282235.*;

/*
 * @test
 * @bug 8282235
 * @summary kextract crashes when a Java keyword is used in as a function pointer typedef parameter name
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Test8282235 --use-system-load-library -t test.kextract.test8282235 test8282235.h
 * @build Test8282235
