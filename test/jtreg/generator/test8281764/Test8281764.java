...
import test.kextract.test8281764.*;

/*
 * @test
 * @bug 8281764
 * @summary kextract does not generate parameter names for function pointer typedefs
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Test8281764 --use-system-load-library -t test.kextract.test8281764 test8281764.h
 * @build Test8281764
