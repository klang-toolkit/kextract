...
import static test.kextract.struct.struct_h.*;
import test.kextract.struct.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Struct --use-system-load-library -t test.kextract.struct struct.h
 * @build LibStructTest
