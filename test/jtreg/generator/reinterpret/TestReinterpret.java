...
import static test.kextract.reinterpret.reinterpret_h.*;
import test.kextract.reinterpret.*;

/*
 * @test
 * @bug 8253102 7903626
 * @summary kextract should emit reinterpret utility method on struct classes
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Reinterpret --use-system-load-library -t test.kextract.reinterpret reinterpret.h
