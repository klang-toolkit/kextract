...
import test.kextract.testStructArrayFields.*;
import static test.kextract.testStructArrayFields.testStructArrayFields_h.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l TestStructArrayFields --use-system-load-library -t test.kextract.testStructArrayFields testStructArrayFields.h
