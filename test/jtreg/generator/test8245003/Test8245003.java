...
import test.kextract.test8245003.*;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertFalse;
import static test.kextract.test8245003.test8245003_h.*;
import static java.lang.foreign.Linker.*;

/*
 * @test
 * @bug 8245003
 * @summary kextract does not generate accessor for MemorySegement typed values
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Test8245003 --use-system-load-library -t test.kextract.test8245003 test8245003.h
 * @build Test8245003
