...
import static test.kextract.funcpointers.func_h.*;
import test.kextract.funcpointers.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Func --use-system-load-library -t test.kextract.funcpointers func.h
