...
import test.kextract.globalaccess.*;

import java.lang.foreign.Arena;
import java.lang.foreign.MemorySegment;

import static org.testng.Assert.*;
import static test.kextract.globalaccess.globalStructAccess_h.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l StructGlobal --use-system-load-library -t test.kextract.globalaccess globalStructAccess.h
