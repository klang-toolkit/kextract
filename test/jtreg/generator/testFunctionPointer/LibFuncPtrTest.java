...
import static test.kextract.fp.funcPtr_h.*;
import test.kextract.fp.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l FuncPtr --use-system-load-library -t test.kextract.fp funcPtr.h
