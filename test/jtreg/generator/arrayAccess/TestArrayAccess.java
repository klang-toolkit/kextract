...
import test.kextract.arrayaccess.*;

import java.lang.foreign.Arena;
import java.lang.foreign.MemorySegment;

import static test.kextract.arrayaccess.array_access_h.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l ArrayAccess --use-system-load-library -t test.kextract.arrayaccess array_access.h
