...
import test.kextract.unsupported.unsupported_h;

import static org.testng.Assert.*;
import static test.kextract.unsupported.unsupported_h.*;
import test.kextract.unsupported.*;

/*
 * @test
 * @library /lib
 * @build testlib.TestUtils
 * @run main/othervm JtregKextract -l Unsupported --use-system-load-library -t test.kextract.unsupported unsupported.h
