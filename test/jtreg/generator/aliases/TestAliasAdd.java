...
import static test.kextract.alias_add.libAsmSymbol_h.*;
 ...
 * @run main/othervm JtregKextract -l AsmSymbol -DADD --use-system-load-library -t test.kextract.alias_add libAsmSymbol.h
 * @build TestAliasAdd
