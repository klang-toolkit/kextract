...
import static test.kextract.alias_mul.libAsmSymbol_h.*;
 ...
 * @run main/othervm JtregKextract -l AsmSymbol --use-system-load-library -t test.kextract.alias_mul libAsmSymbol.h
 * @build TestAliasMul
