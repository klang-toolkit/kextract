 ...
 * @test
 * @library /lib
 * @build testlib.KextractToolRunner testlib.TestUtils
 * @run testng/othervm -Dkextract.decls.per.header=1 TestSplit
 */
public class TestSplit extends KextractToolRunner {
    @Test
