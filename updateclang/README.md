This directory contains files, script needed to update libclang binding in kextract code.

Steps to update libclang binding

* remove the src/main/kotlin/org/openjdk/kextract/clang/libclang folder
* make sure kextract project is built
* cd updateclang (this directory)
* set PATH to point to directory where generated kextract tool lives
...
diff --git a/src/main/kotlin/org/openjdk/kextract/clang/libclang/CXUnsavedFile.java b/src/main/kotlin/org/openjdk/kextract/clang/libclang/CXUnsavedFile.java
index 12d25de..a0ebb98 100644
--- a/src/main/kotlin/org/openjdk/kextract/clang/libclang/CXUnsavedFile.java
+++ b/src/main/kotlin/org/openjdk/kextract/clang/libclang/CXUnsavedFile.java
